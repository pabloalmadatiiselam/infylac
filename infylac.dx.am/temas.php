...
<SECTION>
<ARTICLE>
<h3 class="titulos">Temas espirituales</h3>
<?php
//incluyo libreria
...
//sentencia sql        
$ssql="Select iyt_ndr,iyt_tit,iyt_des from infytemas where iyt_tar=1 order by iyt_ndr";
//mostrar resultados de la consulta
$result= $conexion1->consulta($ssql,$conexion2);
 if($result->num_rows == 0){
    die("No se encontro ningun tema");
}
$conexion1->mostrar_items($result,1);
//liberar resultados
$result->free();
//cerrar conexion
$conexion2->close();         
...
<a href='pdf.php?referencia=1'>Artículos de temas</a>
</ARTICLE>
</SECTION>
<FOOTER>
<div id= "contactos">
    ...
    <div id= "copy">   
    La pagina de temas &copy;. Todos los derechos reservados
    </div>    
</FOOTER>
</div>
</BODY>
